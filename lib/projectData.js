const project1 = {
    ...
    section3 : {
        ...
        image2Para : "Offers clearly highlighted for easy on the spot comparision and social proof in the form of past offer avails",
...
const project3 = {
    section1 : {
        ...
        image2Para : "Indian two-wheeler owners using GPS on their phones attached to their vehicles with the help of a phone mount holder",
        ...
        image3Para : "A HUD helmet powered by AR shows you the way through on screen navigation.",
        ...
        image9Para : "The console can be clamped to the handle, so that it can be handled with the thumb easily while the user is driving.",
...
const project4 = {
    section1 : {
        ...
        image4Para : "Using scrap flex sheets and glue, I made a mock prototype of the bag",
        ...
        image8Para : "Please note that the above model is just a mock-prototype to show the mechanism works. For production, I designed the parts to be me much more sleek and aesthetic.",
...
const project8 = {
    ...
    p0 : {
        title : "Pedal Wash",
        description : "Women in rural India have tough time washing clothes by hand due to power outages that last for hours on a daily basis. So I designed a simple pedal-powered washing machine on a bike. Cardio + Clean clothes :)",
        images : [
    ...
    p1 : {
        ...
        description : "A cute toddler’s table with a word finder puzzle on top. DIY table easy to build and dismantle. Ease in logistics. Made of Pine wood and safe for kids. Adjustable height for 2 levels. ",
        images : [
    ...
    p2 : {
        ...
        description : "This was my first freelancing project. Even though I dint get paid much, I consider this one to be dear to my heart as this was my first “Tech Job”; started my journey as a web designer/dev.",
        images : [
    ...
    p3 : {
        title : "Gift box",
        description : "I designed the 2017 gift boxes for StoreKing’s employees. Made Indian festival themed calendar cards.",
        images : [
    ...
    p4 : {
        ...
        description : "Budget tools designed for Indian farmers. Four common tools used are the axe, paara, sickel tool and saw cutter. All in one kit.",
        images : [
